  ...
  useEffect(() => {
    if (bugNegativePeople) {
      ...
      if (!scoreSetForbugNegativePeople) {
        ...
        seterrorMessage(
          "Hai trovato un bug di validazione: l’app ti lascia inserire un numero di persone negativo per una prenotazione. È come se potessi prenotare un tavolo per –3 persone: assurdo, ma il sistema non lo controlla. Un bug di validazione è un errore nel software che avviene quando il programma non controlla correttamente i dati o le condizioni prima di accettarli o usarli.",
        );
        setpopVisible(true);
      }
    }
