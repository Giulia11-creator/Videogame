...
import backgroundImageUrl from "/background2.png";
import charactersImageUrl from "/characters.png";
export default async function initGame() {
  ...
  // ora le sprite sono caricate correttamente
  k.add([k.sprite("background"), k.pos(0, -70), k.scale(1.3)]);
